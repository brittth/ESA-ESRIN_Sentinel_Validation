...
if(surface =='Land'){
  # APU plot
  apu.ylim <- c(-0.2,0.25) # max 0.2 before but france incomplete
  apu.ybreaks <- seq(-0.2,0.25,0.05)# max 0.2 before but france incomplete
  
  # relative APU plot
  apu.rel.ylim <- c(-50,400) #300 before but france incomplete, this way, same as water
  apu.rel.ybreaks <- seq(-50,400,50)#300 before but france incomplete, this way, same as water
  ...
  # APU plot
  apu.ylim <- c(-0.06,0.06)
  apu.ybreaks <- seq(-0.06,0.06,0.01)
  
  # relative APU plot
  apu.rel.ylim <- c(-50,400)
  apu.rel.ybreaks <- seq(-50,400,50)
